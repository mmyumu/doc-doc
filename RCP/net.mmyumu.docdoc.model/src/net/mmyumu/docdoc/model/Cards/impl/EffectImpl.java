...
public class EffectImpl extends MinimalEObjectImpl.Container implements Effect {
	...
	public void setValue(int newValue) {
		...
		valueESet = true;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CardsPackage.EFFECT__VALUE, oldValue, value, !oldValueESet));
	}
	...
	public void unsetValue() {
		...
		valueESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, CardsPackage.EFFECT__VALUE, oldValue, VALUE_EDEFAULT, oldValueESet));
	}
