 ...
 * <ul>
 *   <li>{@link net.mmyumu.docdoc.model.Cards.impl.SchoolImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SchoolImpl extends MinimalEObjectImpl.Container implements School {
	...
	protected EClass eStaticClass() {
		return CardsPackage.Literals.SCHOOL;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CardsPackage.SCHOOL__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CardsPackage.SCHOOL__NAME:
				return getName();
		}
